							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>客户号</label>
										<input id="kehuhao" name="kehuhao" class="form-control" placeholder="客户号">
									</div>
									<div class="form-group col-md-6">
										<label>密码</label>
									...
									<div class="form-group col-md-6">
										<label>客户姓名</label>
										<input id="kehuxingming" name="kehuxingming" class="form-control" placeholder="客户姓名">
									</div>
									<div class="form-group col-md-6">
										<label>头像</label>
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.kehuhao != null && res.data.kehuhao != ''){

					$("#kehuhao").val(res.data.kehuhao);
					}
