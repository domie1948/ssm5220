...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="kehuhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										客户姓名
									</label>
									<input type="text" id="kehuxingmingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('kehuhao')">客户号<i id="kehuhaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#kehuhaoSearch').val() != null && $('#kehuhaoSearch').val() != ''){
				searchForm.kehuhao ="%" +  $('#kehuhaoSearch').val() + "%";
			}
			
			if($('#kehuxingmingSearch').val() != null && $('#kehuxingmingSearch').val() != ''){
				searchForm.kehuxingming ="%" +  $('#kehuxingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("kehu/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				kehuhao : searchForm.kehuhao,	
				kehuxingming : searchForm.kehuxingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var kehuhaoCell  = document.createElement('td');

						 kehuhaoCell.innerHTML = item.kehuhao;


			row.appendChild(kehuhaoCell);
