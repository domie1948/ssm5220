				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="kafeileixing" id="kafeileixing">
									<option value="">请选择</option>
									<option v-for="(item,index) in kafeileixing" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="jiage" id="jiage" placeholder="价格" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">咖啡详情</label>
							<div class="layui-input-block">
								<input type="text" name="kafeixiangqing" id="kafeixiangqing" placeholder="咖啡详情" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																...
																http.request(`option/kafeileixing/kafeileixing`,'get',{},(res)=>{
					vue.kafeileixing = res.data
				});
