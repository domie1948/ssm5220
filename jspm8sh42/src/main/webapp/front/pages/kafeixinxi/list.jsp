        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">咖啡信息展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">咖啡名称</label>
                <div class="layui-input-inline">
                  <input type="text" name="kafeimingcheng" id="kafeimingcheng" placeholder="咖啡名称" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">咖啡类型</label>
                <div class="layui-input-inline">
                  <input type="text" name="kafeileixing" id="kafeileixing" placeholder="咖啡类型" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('kafeixinxi','新增')" @click="jump('../kafeixinxi/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../kafeixinxi/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../kafeixinxi/detail.jsp?id='+item.id)"><span>{{item.kafeimingcheng}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#kafeimingcheng').val()) {
          param['kafeimingcheng'] = jquery('#kafeimingcheng').val() ? '%' + jquery('#kafeimingcheng').val() + '%' : '';
        }  
        if (jquery('#kafeileixing').val()) {
          param['kafeileixing'] = jquery('#kafeileixing').val() ? '%' + jquery('#kafeileixing').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('kafeixinxi/list', 'get', param, function(res) {
